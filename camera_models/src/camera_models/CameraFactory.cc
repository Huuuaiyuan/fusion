...
CameraFactory::generateCameraFromYamlFile( const std::string& filename )
{
    ...
    // {
    //     std::cout << "error!! in load " << filename << std::endl;
    //     return CameraPtr( );
    // }

    cv::FileStorage fs( filename, cv::FileStorage::READ );

    std::cout << "check if open" << std::endl;
    ...
    std::cout << "start loading camera info" << std::endl;
    ...
    std::cout << "start loading modal type" << std::endl;
