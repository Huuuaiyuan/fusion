...
### 3 traj comparison: 
```
evo_traj tum --ref vio.csv /home/huaiyuan/Downloads/EurocMAV_dataset/vicon1_medium/mav0/state_groundtruth_estimate0/tum.csv vio_opt.csv --align_origin --plot --plot_mode xy
```

### number evaluation:
```
evo_ape tum vio.csv /home/huaiyuan/Downloads/EurocMAV_dataset/vicon1_medium/mav0/state_groundtruth_estimate0/tum.csv --align_origin
```